...
With more time, I plan on adding more runs trail runs with less *ele_gain*. I believe it will force the model to find the effects of *mph* on *hr_avg* more significant, and render the model more usable for my own sake of predicting a speed at which is maintainable for my upcoming hike! Luckily, I have a job as a hiking guide coming up in March, and will be collecting much more data.
